// wrappers and helpers that hit the insight api on a full meowcoincore node
...
function Insight(url) {
    ...
    $.checkArgument(url, 'First argument is required, please include the URL of the API root (e.g. https://meowcoincoin.network/api)');
