...
var BlockHeader = function BlockHeader(arg) {
  ...
  // There is no reason why the insight node should be veriifing block hashes
  // if (info.hash) {
  //   $.checkState(
  //     this.hash === info.hash,
...
BlockHeader.prototype._getHash = function hash() {
  ...
  var kawpow_activation_time = KAWPOW_ACTIVACTION_TIME_MAINNET;

  if (Network.toString() === 'testnet') {
    activation_time = X16RV2_ACTIVATION_TIME_TESTNET;
    kawpow_activation_time = KAWPOW_ACTIVACTION_TIME_TESTNET;
  }


  if (this.time >= KAWPOW_ACTIVACTION_TIME_MAINNET) {
    ...
    console.log("headerhash: %s", headerhash);
    console.log("mixhash: %s", mixhash);
    console.log("height: %d", this.height);
