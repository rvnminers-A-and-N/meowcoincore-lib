...
var script_valid = require('../data/meowcoind/script_valid');
var script_invalid = require('../data/meowcoind/script_invalid');
var tx_valid = require('../data/meowcoind/tx_valid');
var tx_invalid = require('../data/meowcoind/tx_invalid');

//the script string format used in meowcoind data tests
Script.frommeowcoindString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.frommeowcoindString(vector[0]);
    var scriptPubkey = Script.frommeowcoindString(vector[1]);
  ...
  describe('meowcoind script evaluation fixtures', function() {
  ...
  describe('meowcoind transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //meowcoind casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.frommeowcoindString(scriptPubKeyStr);
          });
