...
var HDPrivateKey = meowcoincore.HDPrivateKey;
var HDPublicKey = meowcoincore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = meowcoincore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(meowcoincore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(meowcoincore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      meowcoincore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = meowcoincore.PublicKey.fromPoint;
      meowcoincore.PublicKey.fromPoint = function() {
        meowcoincore.PublicKey.fromPoint = unstubbed;
